...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Assine um Combo TV e Internet
                    <small></small>
                </h1>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel panel-primary text-center">
                    <div class="panel-heading">
                        <h3 class="panel-title">PREMIUM + 1 MEGA</h3>
                    </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-primary text-center">
                    <div class="panel-heading">
                        <h3 class="panel-title">PREMIUM + 2 MEGA</h3>
                    </div>
                    <div class="panel-body">
                        <small>À partir de*</small>
                        <span class="price"><sup>R$</sup>169<sup>,00</sup></span>
                        <span class="period">por mês</span>
                    </div>
                    <ul class="list-group">
            ...
            <div class="col-md-4">
                <div class="panel panel-primary text-center">
                    <div class="panel-heading">
                        <h3 class="panel-title">PREMIUM + 4 MEGA</h3>
                    </div>
                    <div class="panel-body">
                        <small>À partir de*</small>
                        <span class="price"><sup>R$</sup>191<sup>,00</sup></span>
                        <span class="period">por mês</span>
                    </div>
                    <ul class="list-group">
