<%-- 
    Document   : planos-tv
    Created on : 08/07/2016, 00:49:48
    Author     : Thiago
--%>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Conheça os Pacotes
                    <small></small>
                </h1>
                <ol class="breadcrumb">
            ...
            <div class="col-md-4">
                <div class="panel panel-primary text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <span class="price"><sup>R$</sup>45<sup>,00</sup></span>
                        <span class="period">por mês</span>
                    </div>
                    <ul class="list-group">
                        <li class="list-group-item"><strong>41</strong> CANAIS</li>
                        </ul>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-primary text-center">
                    ...
                    <div class="panel-body">
                        <small>À partir de*</small>
                        <span class="price"><sup>R$</sup>90<sup>,00</sup></span>
                        <span class="period">por mês</span>
                    </div>
                    <ul class="list-group">
                        <li class="list-group-item"><strong>64</strong> CANAIS</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-primary text-center">
                    <div class="panel-heading">
                        <h3 class="panel-title">PREMIUM <span class="label label-success">PROMOÇÃO !</span></h3>
                    </div>
                    <div class="panel-body">
                        <small>À partir de*</small>
                        <span class="price"><sup>R$</sup>66<sup>,00</sup></span>
                        <span class="period">por mês</span>
                    </div>
                    <ul class="list-group">
                        <li class="list-group-item"><strong>83</strong> CANAIS</li>
                    </ul>
                </div>
            </div>
            <p>Temos valores promocionais para os condominios do <strong>CARAMINGUAVA</strong> e <strong>CARAGUAVA</strong>. Entre em contato agora!</p>
        </div>
        <!-- /.row -->
